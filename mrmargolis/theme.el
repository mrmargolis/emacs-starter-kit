...
;;slightly modified for some higher contrast on certain elements.  originally from
;; http://github.com/mig/color-theme-vibrant-ink/blob/master/color-theme-vibrant-ink.el
